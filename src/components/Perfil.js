    ...
    return (
        <div className="dashboard-layout-perfil">
            ...
            <main className="main-content-perfil">
                <header className="content-header-perfil">
                    <h2>Editar Perfil</h2>
                </header>
                <div className="content-body-perfil">
                    ...
                    <div className="foto-perfil">
                        ...
                        <button onClick={handleFotoUpload} className="btn-upload-perfil">Actualizar Foto</button>
                    </div>
                    ...
                    <div className="cambiar-password">
                        ...
                        <button className="btn btn-secondary-perfil">Cambiar Contraseña</button>
                    </div>
