...
import VerDisputas from './components/VerDisputas'; // Componente corregido
import ResolverDisputas from './components/ResolverDisputas'; // Componente corregido
    ...
    return (
        <Router>
            <Routes>
                ...
                <Route path="/ver-disputas" element={<ProtectedRoute role="juez"><VerDisputas /></ProtectedRoute>} />
                <Route path="/resolver-disputas" element={<ProtectedRoute role="juez"><ResolverDisputas /></ProtectedRoute>} />
            </Routes>
        </Router>
    );
}
